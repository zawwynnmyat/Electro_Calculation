...
class ResistorSeries extends StatefulWidget {
  const ResistorSeries({Key key}) : super(key: key);

  @override
  _ResistorSeriesState createState() => _ResistorSeriesState();
}

class _ResistorSeriesState extends State<ResistorSeries> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Resistors in Series', style: TextStyle(color: Colors.white),),
            ...
            child:  Center(
              child: ListView(
                children: [
                  Column(
                    children: [
                      Text('Resistors in Series', style: GoogleFonts.lato(fontSize: 25),),
                      SizedBox(height: 8,),
                      Image(
                        image: AssetImage('assets/resistors/resistor_series.png'),
                        width: MediaQuery.of(context).size.width,

                      ),
                      SizedBox(height: 8,),
                      Text('Select number of Resistors (MAX : 6)', style: GoogleFonts.lato(fontSize: 25),),
                      Container(
                      ...
                      MaterialButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            r = r1 + r2 + r3 + r4 + r5 + r6;
                            _answerR = r.toStringAsFixed(2) + ' Ohm';
