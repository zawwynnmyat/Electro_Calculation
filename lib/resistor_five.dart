...
class ResistorFive extends StatefulWidget {
  const ResistorFive({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ResistorFiveState createState() => _ResistorFiveState();
}

class _ResistorFiveState extends State<ResistorFive> {
                ...
                children: [
                  Column(
                    children: [
                      ...
                      SizedBox(height: 8,),
                      Image(
                        image: AssetImage('assets/resistors/resistor_five_band.png'),
                        width: 300,
                        height: 200,
                      ),
                      buildCodeField(),
