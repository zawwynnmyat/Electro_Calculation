...
class ResistorFour extends StatefulWidget {
  const ResistorFour({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ResistorFourState createState() => _ResistorFourState();
}

class _ResistorFourState extends State<ResistorFour> {
            ...
            child:  Center(
              child: ListView(
                children: [
                  Column(
                    children: [
                      Text('Resistor 4 Bands Color Code', style: GoogleFonts.lato(fontSize: 25),),
                      SizedBox(height: 8,),
                      Image(
                        image: AssetImage('assets/resistors/resistor_four_band.png'),
                        width: 300,
                        height: 200,
                      ),
                      buildCodeField(),
                      MaterialButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            _answerToleranceString = tolerance;
